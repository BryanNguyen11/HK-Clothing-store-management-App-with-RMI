...
public class LoaiNhanVien_DAO extends UnicastRemoteObject implements LoaiNhanVien_DAO_Interface {
	...
	public String getTenLoaiNhanVienByMaNhanVien(String maLoaiNV) {
    	        Query query = entityManager.createQuery("SELECT lnv.chucVu FROM LoaiNhanVien lnv WHERE lnv.maLoaiNV = :maLoaiNV");
    	        query.setParameter("maLoaiNV", maLoaiNV);
    	        String tenLoaiNhanVien = (String) query.getSingleResult();
