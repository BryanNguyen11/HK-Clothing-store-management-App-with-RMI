...
public class LoaiKhachHang_DAO extends UnicastRemoteObject implements LoaiKhachHang_DAO_Interface{
    ...
    public String layTenLoaiKhachHangTuMaKhachHang(String maLoaiKH) {
        LoaiKhachHang loaiKhachHang = entityManager.find(LoaiKhachHang.class, maLoaiKH);
      //  entityManager.close();
        return (loaiKhachHang != null) ? loaiKhachHang.getTenLoaiKH() : null;
    }
